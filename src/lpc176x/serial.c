...
#elif CONFIG_LPC_SERIAL_UART1
  DECL_CONSTANT_STR("RESERVE_PINS_serial", "P0.16,P0.15");
  #define GPIO_Rx GPIO(0, 16)
  #define GPIO_Tx GPIO(0, 15)
  #define UARTx LPC_UART1
  #define PCLK_UARTx PCLK_UART1
  #define UARTx_IRQn UART1_IRQn
#elif CONFIG_LPC_SERIAL_UART2
  DECL_CONSTANT_STR("RESERVE_PINS_serial", "P0.11,P0.10");
  #define GPIO_Rx GPIO(0, 11)
  #define GPIO_Tx GPIO(0, 10)
  #define UARTx LPC_UART2
  #define PCLK_UARTx PCLK_UART2
  #define UARTx_IRQn UART2_IRQn
#elif CONFIG_LPC_SERIAL_UART3
...
serial_init(void)
{
    ...
    // Setup pins
    gpio_peripheral(GPIO_Rx, 1, 0);
    gpio_peripheral(GPIO_Tx, 1, 0);
